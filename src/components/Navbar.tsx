          ...
          return (
            <Link key={link.href} href={link.href} style={{ textDecoration:"none" }}>
              <div style={{
                ...
                <span style={{ fontSize:"18px", lineHeight:1 }}>{link.icon}</span>
  ...
  return (
    <div style={{ display:"flex", alignItems:"center", gap:"10px", padding:"8px 12px" }}>
      ...
      <div style={{ overflow:"hidden" }}>
        ...
        <p style={{ fontSize:"10px", color:"var(--muted)", whiteSpace:"nowrap", overflow:"hidden", textOverflow:"ellipsis" }}>
          {user.email}
        </p>
      </div>
    </div>
